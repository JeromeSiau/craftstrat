...
pub struct BacktestTrade {
    ...
    pub entry_book_depth_usdc: f64,
    pub entry_depth_ratio: f64,
    pub exit_price: Option<f64>,
    pub exit_reference_price: Option<f64>,
    pub exit_slippage_bps: Option<f64>,
    pub exit_book_depth_usdc: Option<f64>,
    pub exit_depth_ratio: Option<f64>,
    pub size_usdc: f64,
    pub pnl_usdc: f64,
    #[serde(with = "time::serde::rfc3339")]
    ...
    fn test_backtest_result_serialization_roundtrip() {
        let result = BacktestResult {
            ...
            trades: vec![BacktestTrade {
                ...
                entry_book_depth_usdc: 49.6,
                entry_depth_ratio: 1.0,
                exit_price: Some(0.68),
                exit_reference_price: Some(0.68),
                exit_slippage_bps: Some(0.0),
                exit_book_depth_usdc: Some(60.0),
                exit_depth_ratio: Some(0.8333),
                size_usdc: 50.0,
                pnl_usdc: 4.84,
