...
- **Prod app root**: `/home/ploi/craftstrat.com`
- **Docker in prod**: use `docker compose -f docker-compose.yml ...` (skip the dev override file)

### Required deployment workflow

Use production Git deploys, not manual file copies:
