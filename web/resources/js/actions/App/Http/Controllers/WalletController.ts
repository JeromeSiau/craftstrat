...
destroy.url = (
    ...
    const parsedArgs = {
        wallet: typeof args.wallet === 'object' ? args.wallet.id : args.wallet,
    };
...
export const removeStrategy = (
    args:
        | { wallet: number | { id: number }; strategy: number | { id: number } }
        | [wallet: number | { id: number }, strategy: number | { id: number }],
    options?: RouteQueryOptions,
): RouteDefinition<'delete'> => ({
