...
export default function CancelNode({
    id,
    data,
}: NodeProps & { data: CancelNodeData }) {
    return (
        <div className="rounded-md border-2 border-red-400 bg-red-50 p-2 shadow-sm dark:border-red-600 dark:bg-red-950">
            <div className="mb-1 text-[10px] font-semibold tracking-wide text-red-600 uppercase dark:text-red-400">
                Cancel
            </div>
