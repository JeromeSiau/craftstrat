...
export default function ComparatorNode({
    id,
    data,
}: NodeProps & { data: ComparatorNodeData }) {
    ...
    return (
        <div className="rounded-md border border-gray-300 bg-white p-2 shadow-sm dark:border-gray-600 dark:bg-gray-800">
            <div className="mb-1 text-[10px] font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400">
                Compare
            </div>
