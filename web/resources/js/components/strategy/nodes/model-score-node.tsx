...
export default function ModelScoreNode({
    id,
    data,
}: NodeProps & { data: ModelScoreNodeData }) {
    return (
        <div className="w-52 rounded-md border-2 border-emerald-400 bg-emerald-50 p-2 shadow-sm dark:border-emerald-600 dark:bg-emerald-950">
            <div className="mb-1 text-[10px] font-semibold tracking-wide text-emerald-700 uppercase dark:text-emerald-400">
                Model Score
            </div>
            <div className="space-y-1">
                ...
                <Input
                    ...
                    onChange={(e) =>
                        data.onUpdate(id, { ...data, url: e.target.value })
                    }
