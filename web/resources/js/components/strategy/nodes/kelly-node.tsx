...
export default function KellyNode({
    id,
    data,
}: NodeProps & { data: KellyNodeData }) {
    return (
        <div className="rounded-md border-2 border-emerald-400 bg-emerald-50 p-2 shadow-sm dark:border-emerald-600 dark:bg-emerald-950">
            <div className="mb-1 text-[10px] font-semibold tracking-wide text-emerald-600 uppercase dark:text-emerald-400">
                Kelly Sizer
            </div>
            <Input
                type="number"
