...
export default function ApiFetchNode({
    id,
    data,
}: NodeProps & { data: ApiFetchNodeData }) {
    return (
        <div className="w-48 rounded-md border-2 border-cyan-400 bg-cyan-50 p-2 shadow-sm dark:border-cyan-600 dark:bg-cyan-950">
            <div className="mb-1 text-[10px] font-semibold tracking-wide text-cyan-600 uppercase dark:text-cyan-400">
                API Fetch
            </div>
